...
const TopArea = ({exchangeRate}) => {
    ...
    //console.log(marketData.totalMarketCapUsd, marketData.marketCapChangePercent);
    return (
        <div className='container'>
            ...
            <span className='item'>
                ...
                <span className='value'>
                    {exchangeRate !== null ? parseFloat(exchangeRate).toFixed(2) : 'Loading...'}
                </span>
            </span>
            ...
            <span className='item'>
                ...
                <span className="value">
                    {marketData.totalMarketCapUsd !== null && exchangeRate !== null ? (marketData.totalMarketCapUsd * exchangeRate / 1000000000000).toFixed(1) : 'Loading...'}
                </span>
            ...
            <span className='item'>
                ...
                <span className="value">
                    {marketData.totalVolume24hUsd !== null && exchangeRate !== null ? (marketData.totalVolume24hUsd * exchangeRate / 1000000000000).toFixed(2) : 'Loading...'}
                </span>
